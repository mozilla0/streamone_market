		...
		BEGIN
				 ...
				 if(@CountRows=0)
					begin
						...
						INSERT [dbo].[Configs] ([Id], [Key], [Value], [Type]) VALUES (12, N'CustomerSearchURL', N'https://partnerapi.tdstreamone.ca/endCustomer/search', N'API URL')
						INSERT [dbo].[Configs] ([Id], [Key], [Value], [Type]) VALUES (13, N'OrderSearchUrl', N'https://partnerapi.tdstreamone.ca/order/search', N'API URL')
						INSERT [dbo].[Configs] ([Id], [Key], [Value], [Type]) VALUES (14, N'OrderModifyUrl', N'https://partnerapi.tdstreamone.ca/order/', N'API URL')
						INSERT [dbo].[Configs] ([Id], [Key], [Value], [Type]) VALUES (15, N'OrderDetailUrl', N'https://partnerapi.tdstreamone.ca/order/details/', N'API URL')
						INSERT [dbo].[Configs] ([Id], [Key], [Value], [Type]) VALUES (16, N'ModifyAddOnUrl', N'https://partnerapi.tdstreamone.ca/order/addOns', N'API URL')
						INSERT [dbo].[Configs] ([Id], [Key], [Value], [Type]) VALUES (17, N'ResellerId', N'abcd', N'Reseller Info')
						INSERT [dbo].[Configs] ([Id], [Key], [Value], [Type]) VALUES (18, N'VendorListUrl', N'https://partnerapi.tdstreamone.ca/catalog/vendors', N'API URL')
						INSERT [dbo].[Configs] ([Id], [Key], [Value], [Type]) VALUES (19, N'VendorCatalogSearchUrl', N'https://partnerapi.tdstreamone.ca/catalog/search', N'API URL')
						...
						INSERT [dbo].[Configs] ([Id], [Key], [Value], [Type]) VALUES (25, N'SubscriptionSearchUrl', N'https://partnerapi.tdstreamone.ca/order/subscriptions/', N'API URL')
